...
/**
 * <p>NameFromUniUid class.</p>
 *
 * @author CISC-498
 * @version $Id: $Id
 */
public class NameFromUniUid {
    ...
    private final Logger log = LogManager.getLogger(NameFromUniUid.class);
    
/**
 * <p>findNameFor.</p>
 *
 * @param uniUid a {@link java.lang.String} object.
 * @return a {@link java.lang.String} object.
 */
public String findNameFor(String uniUid)
{
    ...
    if ( null!=uniUid && !uniUid.isEmpty()  ) 
    {

        // construct our SearchString

        String searchString = "(queensucauniuid=" +uniUid +")";
