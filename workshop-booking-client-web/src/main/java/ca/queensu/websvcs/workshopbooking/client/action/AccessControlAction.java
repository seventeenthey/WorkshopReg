...
public class AccessControlAction extends ActionSupport {
    ...
    private final Logger log = LogManager.getLogger(ca.queensu.websvcs.workshopbooking.client.action.AccessControlAction.class);
     ...
     *
     * @return a {@link ca.queensu.websvcs.workshopbooking.client.domain.ClientDataBean} object.
     */
     ...
     *
     * @param stdDataBean a {@link ca.queensu.websvcs.workshopbooking.client.domain.ClientDataBean} object.
     */
